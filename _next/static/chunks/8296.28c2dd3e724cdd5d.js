"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8296],{18296:function(e,r,l){l.r(r),l.d(r,{colorCorrectionPixelShaderWGSL:function(){return c}});var t=l(35606);let i="colorCorrectionPixelShader",a=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;varying vUV: vec2f;var colorTableSampler: sampler;var colorTable: texture_2d<f32>;const SLICE_COUNT: f32=16.0; 
...
@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var screen_color: vec4f=textureSample(textureSampler,textureSamplerSampler,input.vUV);fragmentOutputs.color=sampleAs3DTexture(screen_color.rgb,SLICE_COUNT);}`;t.v.ShadersStoreWGSL[i]=a;let c={name:i,shader:a}}}]);