"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6426],{66426:function(r,e,t){t.r(e),t.d(e,{vrDistortionCorrectionPixelShaderWGSL:function(){return f}});var a=t(35606);let n="vrDistortionCorrectionPixelShader",m=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;a.v.ShadersStoreWGSL[n]=m;let f={name:n,shader:m}}}]);