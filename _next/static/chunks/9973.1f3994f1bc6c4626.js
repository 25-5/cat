"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9973],{84278:function(e,o,i){var t=i(35606);i(12784);let n=`layout(std140,column_major) uniform;uniform Material
...
`;t.v.IncludesShadersStore.backgroundUboDeclaration=n},63837:function(e,o,i){var t=i(35606);let n=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#define inline
vec3 computeProjectionTextureDiffuseLighting(sampler2D projectionLightSampler,mat4 textureProjectionMatrix,vec3 posW){vec4 strq=textureProjectionMatrix*vec4(posW,1.0);strq/=strq.w;vec3 textureColor=texture2D(projectionLightSampler,strq.xy).rgb;return textureColor;}`;t.v.IncludesShadersStore.lightsFragmentFunctions=n},49973:function(e,o,i){i.r(o),i.d(o,{backgroundPixelShader:function(){return c}});var t=i(35606);let n=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;t.v.IncludesShadersStore.backgroundFragmentDeclaration=n,i(84278),i(54037),i(90746),i(27179),i(39361),i(86525),i(63837),i(89592),i(78756),i(73196),i(93456),i(92521);let r=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;t.v.IncludesShadersStore.intersectionFunctions=r,i(64269),i(93248),i(83030),i(44203);let l="backgroundPixelShader",f=`#ifdef TEXTURELODSUPPORT
...
`;t.v.ShadersStore[l]=f;let c={name:l,shader:f}}}]);