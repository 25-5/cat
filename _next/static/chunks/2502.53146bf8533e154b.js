"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2502],{32502:function(e,i,r){r.r(i),r.d(i,{iblGenerateVoxelMipPixelShader:function(){return c}});var u=r(35606);let t="iblGenerateVoxelMipPixelShader",o=`precision highp float;precision highp sampler3D;varying vec2 vUV;uniform sampler3D srcMip;uniform int layerNum;void main(void) {ivec3 Coords=ivec3(2)*ivec3(gl_FragCoord.x,gl_FragCoord.y,layerNum);uint tex =
...
<< 7u;glFragColor.rgb=vec3(float(tex)/255.0f,0.0f,0.0f);glFragColor.a=1.0;}`;u.v.ShadersStore[t]=o;let c={name:t,shader:o}}}]);