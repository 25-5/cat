"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2809],{5761:function(e,i,o){var r=o(35606);let f=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;r.v.IncludesShadersStore.decalFragment=f},76393:function(e,i,o){var r=o(35606);let f=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;r.v.IncludesShadersStore.decalFragmentDeclaration=f},55649:function(e,i,o){var r=o(35606);o(12784),o(92492);let f=`layout(std140,column_major) uniform;uniform Material
...
`;r.v.IncludesShadersStore.defaultUboDeclaration=f},91513:function(e,i,o){var r=o(35606);let f=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;r.v.IncludesShadersStore.depthPrePass=f},63837:function(e,i,o){var r=o(35606);let f=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#define inline
vec3 computeProjectionTextureDiffuseLighting(sampler2D projectionLightSampler,mat4 textureProjectionMatrix,vec3 posW){vec4 strq=textureProjectionMatrix*vec4(posW,1.0);strq/=strq.w;vec3 textureColor=texture2D(projectionLightSampler,strq.xy).rgb;return textureColor;}`;r.v.IncludesShadersStore.lightsFragmentFunctions=f},77242:function(e,i,o){var r=o(35606);let f=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;r.v.IncludesShadersStore.mainUVVaryingDeclaration=f},10459:function(e,i,o){var r=o(35606);let f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;r.v.IncludesShadersStore.oitDeclaration=f},97228:function(e,i,o){var r=o(35606);let f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;r.v.IncludesShadersStore.oitFragment=f},42962:function(e,i,o){var r=o(35606);let f=`#ifdef PREPASS
#extension GL_EXT_draw_buffers : require
...
#endif
#endif
`;r.v.IncludesShadersStore.prePassDeclaration=f},82809:function(e,i,o){o.r(i),o.d(i,{defaultPixelShader:function(){return a}});var r=o(35606);o(76393);let f=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;r.v.IncludesShadersStore.defaultFragmentDeclaration=f,o(55649),o(42962),o(10459),o(77242),o(54037),o(39361),o(86525),o(63837),o(89592),o(76437);let t=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;r.v.IncludesShadersStore.fresnelFunction=t,o(90746),o(27179),o(78756),o(21400),o(20029),o(93456),o(73196),o(92521),o(64269),o(24348),o(5761),o(91513),o(93248),o(83030),o(44203),o(97228);let n="defaultPixelShader",l=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;r.v.ShadersStore[n]=l;let a={name:n,shader:l}}}]);