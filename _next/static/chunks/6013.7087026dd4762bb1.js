"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6013],{5761:function(e,i,n){var a=n(35606);let o=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;a.v.IncludesShadersStore.decalFragment=o},76393:function(e,i,n){var a=n(35606);let o=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;a.v.IncludesShadersStore.decalFragmentDeclaration=o},91513:function(e,i,n){var a=n(35606);let o=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;a.v.IncludesShadersStore.depthPrePass=o},68146:function(e,i,n){var a=n(35606);let o=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;a.v.IncludesShadersStore.harmonicsFunctions=o},48550:function(e,i,n){var a=n(35606);let o=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStore.hdrFilteringFunctions=o},66311:function(e,i,n){var a=n(35606);let o=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStore.importanceSampling=o},77242:function(e,i,n){var a=n(35606);let o=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;a.v.IncludesShadersStore.mainUVVaryingDeclaration=o},10459:function(e,i,n){var a=n(35606);let o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.v.IncludesShadersStore.oitDeclaration=o},97228:function(e,i,n){var a=n(35606);let o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;a.v.IncludesShadersStore.oitFragment=o},73446:function(e,i,n){var a=n(35606);let o=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;a.v.IncludesShadersStore.pbrBRDFFunctions=o},28430:function(e,i,n){var a=n(35606);n(12784),n(92492);let o=`layout(std140,column_major) uniform;uniform Material {vec2 vAlbedoInfos;vec4 vAmbientInfos;vec2 vOpacityInfos;vec2 vEmissiveInfos;vec2 vLightmapInfos;vec3 vReflectivityInfos;vec2 vMicroSurfaceSamplerInfos;vec2 vReflectionInfos;vec2 vReflectionFilteringInfo;vec3 vReflectionPosition;vec3 vReflectionSize;vec3 vBumpInfos;mat4 albedoMatrix;mat4 ambientMatrix;mat4 opacityMatrix;mat4 emissiveMatrix;mat4 lightmapMatrix;mat4 reflectivityMatrix;mat4 microSurfaceSamplerMatrix;mat4 bumpMatrix;vec2 vTangentSpaceParams;mat4 reflectionMatrix;vec3 vReflectionColor;vec4 vAlbedoColor;vec4 vLightingIntensity;vec3 vReflectionMicrosurfaceInfos;float pointSize;vec4 vReflectivityColor;vec3 vEmissiveColor;vec3 vAmbientColor;vec2 vDebugMode;vec4 vMetallicReflectanceFactors;vec2 vMetallicReflectanceInfos;mat4 metallicReflectanceMatrix;vec2 vReflectanceInfos;mat4 reflectanceMatrix;vec3 vSphericalL00;vec3 vSphericalL1_1;vec3 vSphericalL10;vec3 vSphericalL11;vec3 vSphericalL2_2;vec3 vSphericalL2_1;vec3 vSphericalL20;vec3 vSphericalL21;vec3 vSphericalL22;vec3 vSphericalX;vec3 vSphericalY;vec3 vSphericalZ;vec3 vSphericalXX_ZZ;vec3 vSphericalYY_ZZ;vec3 vSphericalZZ;vec3 vSphericalXY;vec3 vSphericalYZ;vec3 vSphericalZX;
#define ADDITIONAL_UBO_DECLARATION
};
#include<sceneUboDeclaration>
#include<meshUboDeclaration>
`;a.v.IncludesShadersStore.pbrUboDeclaration=o},42962:function(e,i,n){var a=n(35606);let o=`#ifdef PREPASS
#extension GL_EXT_draw_buffers : require
...
#endif
#endif
`;a.v.IncludesShadersStore.prePassDeclaration=o},66013:function(e,i,n){n.r(i),n.d(i,{pbrPixelShader:function(){return V}});var a=n(35606);n(42962),n(10459),n(76393);let o=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;a.v.IncludesShadersStore.pbrFragmentDeclaration=o,n(28430),n(77242);let r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;a.v.IncludesShadersStore.pbrFragmentExtraDeclaration=r,n(39361),n(86525),n(76437);let t=`#ifdef _DEFINENAME_
...
#endif
#endif
`;a.v.IncludesShadersStore.samplerFragmentAlternateDeclaration=t;let f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;a.v.IncludesShadersStore.pbrFragmentSamplersDeclaration=f,n(27179),n(93456),n(73196),n(92521),n(54037),n(40762),n(66311);let l=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;a.v.IncludesShadersStore.pbrHelperFunctions=l,n(78756),n(89592),n(68146);let c=`struct preLightingInfo
...
#endif
return result;}`;a.v.IncludesShadersStore.pbrDirectLightingSetupFunctions=c;let d=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;a.v.IncludesShadersStore.pbrDirectLightingFalloffFunctions=d,n(73446),n(48550);let s=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;a.v.IncludesShadersStore.pbrDirectLightingFunctions=s;let E=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;a.v.IncludesShadersStore.pbrIBLFunctions=E,n(21400),n(20029),n(90746),n(5761);let R=`struct albedoOpacityOutParams
...
`;a.v.IncludesShadersStore.pbrBlockAlbedoOpacity=R;let C=`struct reflectivityOutParams
...
`;a.v.IncludesShadersStore.pbrBlockReflectivity=C;let u=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;a.v.IncludesShadersStore.pbrBlockAmbientOcclusion=u;let v=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;a.v.IncludesShadersStore.pbrBlockAlphaFresnel=v;let m=`#ifdef ANISOTROPIC
...
#endif
`;a.v.IncludesShadersStore.pbrBlockAnisotropic=m;let S=`#ifdef REFLECTION
...
#endif
`;a.v.IncludesShadersStore.pbrBlockReflection=S;let A=`#ifdef SHEEN
...
#endif
`;a.v.IncludesShadersStore.pbrBlockSheen=A;let I=`struct clearcoatOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStore.pbrBlockClearcoat=I;let N=`struct iridescenceOutParams
...
#endif
`;a.v.IncludesShadersStore.pbrBlockIridescence=N;let p=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;a.v.IncludesShadersStore.pbrBlockSubSurface=p,n(64269);let T=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;a.v.IncludesShadersStore.pbrBlockNormalGeometric=T,n(24348);let O=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;a.v.IncludesShadersStore.pbrBlockNormalFinal=O,n(91513);let L=`#ifdef LIGHTMAP
...
#endif
`;a.v.IncludesShadersStore.pbrBlockLightmapInit=L;let g=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;a.v.IncludesShadersStore.pbrBlockGeometryInfo=g;let _=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;a.v.IncludesShadersStore.pbrBlockReflectance0=_;let h=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;a.v.IncludesShadersStore.pbrBlockReflectance=h;let D=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;a.v.IncludesShadersStore.pbrBlockDirectLighting=D,n(93248);let M=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
#endif
#endif
`;a.v.IncludesShadersStore.pbrBlockFinalLitComponents=M;let F=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo.rgb;finalDiffuse=max(finalDiffuse,0.0);finalDiffuse*=vLightingIntensity.x;vec3 finalAmbient=vAmbientColor;finalAmbient*=surfaceAlbedo.rgb;vec3 finalEmissive=vEmissiveColor;
#ifdef EMISSIVE
...
`;a.v.IncludesShadersStore.pbrBlockFinalUnlitComponents=F;let P=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;a.v.IncludesShadersStore.pbrBlockFinalColorComposition=P,n(83030),n(44203);let b=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;a.v.IncludesShadersStore.pbrBlockImageProcessing=b;let U=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;a.v.IncludesShadersStore.pbrBlockPrePass=U,n(97228);let B=`#if DEBUGMODE>0
...
#endif
`;a.v.IncludesShadersStore.pbrDebug=B;let G="pbrPixelShader",y=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;a.v.ShadersStore[G]=y;let V={name:G,shader:y}}}]);