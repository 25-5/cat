"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2141],{32141:function(e,i,f){f.r(i),f.d(i,{glowMapGenerationPixelShaderWGSL:function(){return n}});var a=f(35606);f(57104),f(78122),f(56506);let r="glowMapGenerationPixelShader",l=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;a.v.ShadersStoreWGSL[r]=l;let n={name:r,shader:l}}}]);