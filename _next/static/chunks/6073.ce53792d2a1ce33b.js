"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6073],{68445:function(e,r,f){var a=f(35606);let t=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
`;a.v.IncludesShadersStoreWGSL.pbrBRDFFunctions=t},76073:function(e,r,f){f.r(r),f.d(r,{hdrIrradianceFilteringPixelShaderWGSL:function(){return i}});var a=f(35606);f(57104),f(61834),f(61610),f(68445);let t="hdrIrradianceFilteringPixelShader",n=`#include<helperFunctions>
...
#endif
);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;a.v.ShadersStoreWGSL[t]=n;let i={name:t,shader:n}}}]);