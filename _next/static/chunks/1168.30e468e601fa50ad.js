"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[1168],{31168:function(e,l,i){i.r(l),i.d(l,{colorCorrectionPixelShader:function(){return c}});var r=i(35606);let t="colorCorrectionPixelShader",o=`uniform sampler2D textureSampler; 
...
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;r.v.ShadersStore[t]=o;let c={name:t,shader:o}}}]);