"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8946],{68445:function(e,r,f){var a=f(35606);let t=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;a.v.IncludesShadersStoreWGSL.hdrFilteringFunctions=t},61834:function(e,r,f){var a=f(35606);let t=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;a.v.IncludesShadersStoreWGSL.importanceSampling=t},61610:function(e,r,f){var a=f(35606);let t=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
`;a.v.IncludesShadersStoreWGSL.pbrBRDFFunctions=t},8946:function(e,r,f){f.r(r),f.d(r,{hdrFilteringPixelShaderWGSL:function(){return i}});var a=f(35606);f(57104),f(61834),f(61610),f(68445);let t="hdrFilteringPixelShader",n=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform alphaG: f32;var inputTextureSampler: sampler;var inputTexture: texture_cube<f32>;uniform vFilteringInfo: vec2f;uniform hdrScale: f32;varying direction: vec3f;@fragment
fn main(input: FragmentInputs)->FragmentOutputs {var color: vec3f=radiance(uniforms.alphaG,inputTexture,inputTextureSampler,input.direction,uniforms.vFilteringInfo);fragmentOutputs.color= vec4f(color*uniforms.hdrScale,1.0);}`;a.v.ShadersStoreWGSL[t]=n;let i={name:t,shader:n}}}]);