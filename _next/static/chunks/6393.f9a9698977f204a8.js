"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6393],{36393:function(e,t,r){r.r(t),r.d(t,{iblIcdfPixelShaderWGSL:function(){return u}});var a=r(35606);r(57104);let i="iblIcdfPixelShader",c=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;a.v.ShadersStoreWGSL[i]=c;let u={name:i,shader:c}}}]);