...
#endif
return result;}
fn computeProjectionTextureDiffuseLighting(projectionLightTexture: texture_2d<f32>,projectionLightSampler: sampler,textureProjectionMatrix: mat4x4f,posW: vec3f)->vec3f {var strq: vec4f=textureProjectionMatrix*vec4f(posW,1.0);strq/=strq.w;var textureColor: vec3f=textureSample(projectionLightTexture,projectionLightSampler,strq.xy).rgb;return textureColor;}`;i.v.IncludesShadersStoreWGSL.lightsFragmentFunctions=f},96414:function(e,r,o){o.r(r),o.d(r,{backgroundPixelShaderWGSL:function(){return l}});var i=o(35606);o(73765),o(57104),o(53584),o(87552),o(59754),o(16925),o(519),o(18472),o(22706),o(78122),o(38632);let f=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;i.v.IncludesShadersStoreWGSL.intersectionFunctions=f,o(56506),o(55960),o(24636),o(59712);let n="backgroundPixelShader",t=`#include<backgroundUboDeclaration>
...
`;i.v.ShadersStoreWGSL[n]=t;let l={name:n,shader:t}}}]);