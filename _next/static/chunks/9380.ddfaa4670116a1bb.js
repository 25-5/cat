"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9380],{69380:function(e,r,f){f.r(r),f.d(r,{iblCdfDebugPixelShaderWGSL:function(){return u}});var c=f(35606);let t="iblCdfDebugPixelShader",i=`#define PI 3.1415927
...
fragmentOutputs.color =vec4(mix(colour,backgroundColour,0.5),1.0);}`;c.v.ShadersStoreWGSL[t]=i;let u={name:t,shader:i}}}]);