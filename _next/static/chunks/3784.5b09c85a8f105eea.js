"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[3784],{10955:function(e,r,a){var i=a(35606);let n=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;i.v.IncludesShadersStoreWGSL.bumpFragment=n},93523:function(e,r,a){var i=a(35606);a(55985);let n=`#if defined(BUMP)
...
#endif
`;i.v.IncludesShadersStoreWGSL.bumpFragmentFunctions=n},40809:function(e,r,a){var i=a(35606);let n=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;i.v.IncludesShadersStoreWGSL.bumpFragmentMainFunctions=n},82842:function(e,r,a){var i=a(35606);let n=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;i.v.IncludesShadersStoreWGSL.depthPrePass=n},25857:function(e,r,a){var i=a(35606);let n=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.harmonicsFunctions=n},68445:function(e,r,a){var i=a(35606);let n=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.hdrFilteringFunctions=n},61834:function(e,r,a){var i=a(35606);let n=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;i.v.IncludesShadersStoreWGSL.importanceSampling=n},29524:function(e,r,a){var i=a(35606);let n=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;i.v.IncludesShadersStoreWGSL.mainUVVaryingDeclaration=n},7675:function(e,r,a){var i=a(35606);let n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;i.v.IncludesShadersStoreWGSL.oitDeclaration=n},95613:function(e,r,a){var i=a(35606);let n=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;i.v.IncludesShadersStoreWGSL.oitFragment=n},61610:function(e,r,a){var i=a(35606);let n=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.prePassDeclaration=n},55985:function(e,r,a){var i=a(35606);let n=`#ifdef _DEFINENAME_
...
#endif
`;i.v.IncludesShadersStoreWGSL.samplerFragmentDeclaration=n},33784:function(e,r,a){a.r(r),a.d(r,{pbrPixelShaderWGSL:function(){return x}});var i=a(35606);a(55203),a(7675),a(69964),a(29524);let n=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrFragmentExtraDeclaration=n,a(59754),a(55985);let f=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.samplerFragmentAlternateDeclaration=f;let t=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrFragmentSamplersDeclaration=t,a(87552),a(78122),a(22706),a(38632),a(57104);let o=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;i.v.IncludesShadersStoreWGSL.subSurfaceScatteringFunctions=o,a(61834);let c=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrHelperFunctions=c,a(18472),a(519),a(25857);let l=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
return result;}`;i.v.IncludesShadersStoreWGSL.pbrDirectLightingSetupFunctions=l;let d=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;i.v.IncludesShadersStoreWGSL.pbrDirectLightingFalloffFunctions=d,a(61610),a(68445);let s=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrDirectLightingFunctions=s;let v=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrIBLFunctions=v,a(40809),a(93523),a(53584),a(55836);let E=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;i.v.IncludesShadersStoreWGSL.pbrBlockAlbedoOpacity=E;let m=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;i.v.IncludesShadersStoreWGSL.pbrBlockReflectivity=m;let u=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;i.v.IncludesShadersStoreWGSL.pbrBlockAmbientOcclusion=u;let S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockAlphaFresnel=S;let p=`#ifdef ANISOTROPIC
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockAnisotropic=p;let R=`#ifdef REFLECTION
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockReflection=R;let C=`#ifdef SHEEN
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockSheen=C;let A=`struct clearcoatOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockClearcoat=A;let N=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockIridescence=N;let I=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockSubSurface=I,a(56506);let O=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockNormalGeometric=O,a(10955);let T=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockNormalFinal=T,a(82842);let L=`#ifdef LIGHTMAP
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockLightmapInit=L;let h=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockGeometryInfo=h;let g=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockReflectance0=g;let M=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockReflectance=M;let _=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockDirectLighting=_,a(55960);let D=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
`;i.v.IncludesShadersStoreWGSL.pbrBlockFinalUnlitComponents=F;let P=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;i.v.IncludesShadersStoreWGSL.pbrBlockFinalColorComposition=P,a(24636),a(59712);let b=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockImageProcessing=b;let U=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrBlockPrePass=U,a(95613);let B=`#if DEBUGMODE>0
...
#endif
`;i.v.IncludesShadersStoreWGSL.pbrDebug=B;let G="pbrPixelShader",y=`#define CUSTOM_FRAGMENT_BEGIN
...
`;i.v.ShadersStoreWGSL[G]=y;let x={name:G,shader:y}}}]);