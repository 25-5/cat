"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[2507],{72507:function(e,l,o){o.r(l),o.d(l,{iblVoxelGrid3dDebugPixelShader:function(){return s}});var i=o(35606);let a="iblVoxelGrid3dDebugPixelShader",r=`precision highp sampler3D;varying vec2 vUV;uniform sampler3D voxelTexture;uniform sampler2D voxelSlabTexture;uniform sampler2D textureSampler;uniform vec4 sizeParams;
...
glFragColor.rgb=mix(background.rgb,voxelSlab.rgb,voxelSlab.a)+voxel;glFragColor.a=1.0;}}`;i.v.ShadersStore[a]=r;let s={name:a,shader:r}}}]);